...
class UserController extends Controller
{
    ...
    {
        return view('users.show', ['user' => $user, 'school' => $school]);
    }
    ...
    //subdomain users billings
     public function billingsBusiness(Request $request)
     {
        ...
        if (Auth::check()) {
            return view('users.billings_business', ['school' => $school]);
        }
        else {
            return redirect('home');
        }
     ...
     public function showFormContactSubDomain(Request $request)
     {
         $subdomain = $request->route('domain') ?? $request->route('subdomain');
         $school = School::where('id', $subdomain)
             ->orWhere('slug', $subdomain)
        ...
        if (Auth::check()) {
            return view('users.contact_business', ['school' => $school]);
        }
        else {
            return redirect('home');
        }
