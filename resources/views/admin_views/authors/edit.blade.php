...
<style media="screen">
        ...
        *,*:before,*:after{-webkit-box-sizing:inherit;box-sizing:inherit;}
        ...
        <div ui-view="content" ng-class="sidebarCollapsed" class="admin-content" style="">
            ...
            <form method="post" action="/authors/{{$author->id}}/update" class="inline-form-wrapper ng-pristine ng-valid ng-valid-maxlength" style="">
                    ...
                    <div ng-if="planType" class="" style=""><a ng-click="resetPlanType()" href="/schoolAdmin/{{$school->id}}/authors/" class="tch-inline-back fastclickable"><i what="fa-chevron-left" class="fa fa-chevron-left"></i></a>
                        ...
                        <div class="inline-form-container col-sm-6 col-sm-offset-3">
                            ...
                            <div ng-if="planType == 'free'" class="col-sm-12">
                                ...
                                <div class="input-group input-group-label"><span>Modifier l'autheur</span></div>
                            </div>
                            <!---->
                            <!---->
                            <!---->
                            ...
                            <div class="col-sm-12 add-top-margin-25"><input type="text" name="full_name" value="{{$author->full_name}}" maxlength="100" placeholder="Nom de l'autheur"
                                      class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-maxlength">
        
                                  </div>
                                <div class="col-sm-12 add-top-margin-25"><input type="text" name="bio" value="{!!$author->bio!!}" maxlength="100" placeholder="La bio de l'autheur"
                                      class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-maxlength">
