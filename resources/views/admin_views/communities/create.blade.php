...
@section('title', 'Ajouter une nouvelle communauté')
@section('content')
        ...
        <div ui-view="content" ng-class="sidebarCollapsed" class="admin-content" style="">
            ...
            <div class="tch-inline-form">
                ...
                <div class="survey-container col-sm-6 col-sm-offset-3 col-xs-12 m-v-6-m">
                    ...
                    <form enctype="multipart/form-data" method="post" action="{{route('communities.store',$school->id)}}" class="ng-pristine ng-valid ng-valid-schema-form" id="information-container">
                            @csrf
                        ...
                        <bootstrap-decorator form="schemaForm.form[11]">
                            <div class="form-group schema-form-submit ">
                                <!----><input type="submit" class="btn tch-btn-header-primary-block " value="Créez la communauté">
                                <!---->
                                <!---->
                            </div>
                        </bootstrap-decorator>
