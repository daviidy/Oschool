...
@section('title', 'Modifier la communauté')
@section('content')
        ...
        <div ui-view="content" ng-class="sidebarCollapsed" class="admin-content" style="">
            ...
            <div class="tch-inline-form">
                ...
                <div class="survey-container col-sm-6 col-sm-offset-3 col-xs-12 m-v-6-m">
                    ...
                    <form enctype="multipart/form-data" method="post" action="{{url('communities',$community)}}" class="ng-pristine ng-valid ng-valid-schema-form" id="information-container">
                            @csrf
                            {{ method_field('patch') }}

                         <a href="/schoolAdmin/{{$school->id}}/communities" class="tch-inline-back fastclickable"><i what="fa-chevron-left" class="fa fa-chevron-left"></i></a>
                        ...
                        <bootstrap-decorator form="schemaForm.form[5]">
                            <div ng-class="{'has-error': form.disableErrorState !== true &amp;&amp; hasError(), 'has-success': form.disableSuccessState !== true &amp;&amp; hasSuccess(), 'has-feedback': form.feedback !== false}"
                              class="form-group schema-form-select  has-feedback"><label ng-show="showTitle()" class="control-label">Modifier la communauté</label>
                              <input type="url" name="link" value="{{$community->link}}">
                        ...
                        <bootstrap-decorator form="schemaForm.form[5]">
                            <div ng-class="{'has-error': form.disableErrorState !== true &amp;&amp; hasError(), 'has-success': form.disableSuccessState !== true &amp;&amp; hasSuccess(), 'has-feedback': form.feedback !== false}"
                              ...
                              <input type="password" name="password" value="{{$community->password}}">
                        ...
                        <bootstrap-decorator form="schemaForm.form[11]">
                            <div class="form-group schema-form-submit ">
                                <!----><input type="submit" class="btn tch-btn-header-primary-block " value="Modifier la communauté">
                                <!---->
                                <!---->
                            </div>
                        </bootstrap-decorator>
