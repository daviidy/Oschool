...
@section('title', 'Ajouter un nouveau coupon')
@section('content')
        ...
        <div ui-view="content" ng-class="sidebarCollapsed" class="admin-content" style="">
            ...
            <form method="POST" action="{{route('coupons.store')}}" enctype="multipart/form-data" class="inline-form-wrapper ng-pristine ng-valid ng-valid-maxlength" style="" enctype="multipart/form-data" id="editor-container">
                ...
                {{ method_field('POST') }}
                    <!---->
                    <!---->
                    <div ng-if="planType" class="" style=""><a ng-click="resetPlanType()" href="/schoolAdmin/{{$school->id}}/courses/{{$course->id}}/coupons" class="tch-inline-back fastclickable"><i what="fa-chevron-left" class="fa fa-chevron-left"></i></a>
                        <!---->
                        <!---->
                        <!---->
                        <div class="inline-form-container col-sm-6 col-sm-offset-3">
                            ...
                            <div ng-if="planType == 'free'" class="col-sm-12">
                                ...
                                <div class="input-group input-group-label"><span>Création de coupon</span></div>
                            </div>
                            <!---->
                            <!---->
                            <!---->
                            ...
                            <div class="col-sm-12 add-top-margin-25">
                                ...
                                <br>
                                <input type="text" placeholder="Ex: OSCXXX" name="code" id="code">
                                <br>
                            ...
                            <div class="col-sm-12 add-top-margin"><button id="test-id-save-btn" type="submit" ng-disabled="!inlinePricingForm.$valid" class="tch-btn-header-primary-block">Créé le coupon</button></div>
                        </div>
                    </div>
                    <!---->
                </form>
