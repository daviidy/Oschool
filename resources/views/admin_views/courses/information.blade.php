        ...
        <div class="modal-content" modal-transclude="" trackid="1788">
            <div what="confirm modal">
                <div class="modal-body angular-confirm-text" trackid="1786">
                    <!---->
                    <h4 ng-if="data.title" ng-bind="::data.title" class="angular-confirm-title" trackid="1804" style="">Confirm</h4>
                    <!---->
                    <p what="text" ng-bind="::data.text" class="angular-confirm-copy" trackid="1805">Are you really, really sure you want to delete this course? This action is irreversible.</p>
                </div>
                <div class="modal-footer center angular-confirm-footer" trackid="1787">
                    <!----><button what="cancel button" ng-if="data.cancel" ng-click="cancel()" ng-bind="::data.cancel || 'Cancel'" class="tch-btn-header-secondary fastclickable" trackid="1806" style="">Cancel</button>
