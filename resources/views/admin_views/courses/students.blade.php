            ...
            <table ng-if="products.length > 0" class="tch-table draggable-products">
                <thead>
                    <tr>
                        ...
                        <th>Offre choisie</th>
                        <th>A jour ?</th>
                        <th>Prochaine date de paiement<a href="#" tooltip="The default price will be set to the first pricing plan on this list." tooltip-placement="bottom" tooltip-trigger="mouseenter" tooltip-append-to-body="true" class="tch-btn-tooltip no-padding"><i
                                  class="fa fa-question-circle"></i></a></th>
                        <th>Reste à payer</th>
                        <th>Progression de l'étudiant</th>
                ...
                <tbody ui-sortable="sortableOptions" ng-model="products" class="ng-pristine ng-untouched ng-valid ui-sortable ng-not-empty">
                    ...
                    @foreach($course->users as $user)
                        @if($user->purchases->where('user_id', $user->id)->where('status', 'Validé')->where('course_id', $course->id)
