...
@section('title', 'Liste des notifications envoyées aux étudiants')
@section('content')
                ...
                <tbody ui-sortable="sortableOptions" ng-model="products" class="ng-pristine ng-untouched ng-valid ui-sortable ng-not-empty">
                    ...
                    <tr what="product" which="Free Course" ng-repeat="product in products" class="border-bottom ui-sortable-handle">
                        ...
                        <td>
                            ...
                            <a href="/schoolAdmin/{{$school->id}}/courses/{{$course->id}}/coupons/{{$information->id}}/edit">
                                ...
                                <form action="{{ route('coupons.destroy', $information->id) }}" method="post">
                                    @csrf
                                    {{ method_field('delete') }}
                                    <button
