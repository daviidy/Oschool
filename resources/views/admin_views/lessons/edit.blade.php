...
<!-- The Modal -->
  <div class="modal fade" id="formLive">
    <div style="width: 100%" class="modal-dialog">
      <div class="modal-content">

        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Insérez le lien de la conférence</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>

        <!-- Modal body -->
        <div class="modal-body">
            <form class="" action="/addConference" method="post" enctype="multipart/form-data">
                @csrf
                <input type="url" name="webinar_meeting" what="question text"
                  class="form-control ng-valid ng-not-empty ng-dirty ng-valid-parse ng-touched" style="">
                 <input hidden type="text" name="lesson_id" value="{{$lesson->id}}">
