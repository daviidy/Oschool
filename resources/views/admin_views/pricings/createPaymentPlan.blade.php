...
@section('title', 'Ajouter une offre de paiement en une fois')
@section('content')
        ...
        <form method="post" action="{{route('pricings.store')}}" class="inline-form-wrapper ng-pristine ng-valid-maxlength ng-invalid ng-invalid-required ng-valid-min ng-valid-max" style="" id="abplan-container">
            ...
            <div ng-if="planType" class="" style=""><a ng-click="resetPlanType()" href="/schoolAdmin/{{$school->id}}/courses/{{$course->id}}/pricing" class="tch-inline-back fastclickable"><i what="fa-chevron-left" class="fa fa-chevron-left"></i></a>
                ...
                <!----><a what="learn-more-about-payment-plan" ng-href="https://teachable.zendesk.com/hc/en-us/articles/219442088-Overview-of-Course-Pricing-Options" target="_blank" ng-if="planType == 'plan'" class="tch-inline-support-article"
                  href="https://teachable.zendesk.com/hc/en-us/articles/219442088-Overview-of-Course-Pricing-Options"><span>Learn more about Payment Plans</span></a>
                <!---->
                <div class="inline-form-container col-sm-6 col-sm-offset-3">
                    ...
                    <div ng-if="planType != 'free'" class="col-sm-12">
                        <div class="input-group input-group-image"><img ng-src="/images/divers/icon-pricing-plan.svg" class="tch-table-thumb" src="/images/divers/icon-pricing-plan.svg"></div>
