...
@section('title', 'Modifier une offre de plan de paiement')
@section('content')
...
.form-control.select-number{width:63px;float:left;margin-right:12px;height:31px;}
...
input[type='number']{padding:0 8px 0 10px;position:relative;}
...
<div ui-view="content" ng-class="sidebarCollapsed" class="admin-content" style="">
        ...
        <div ng-class="{ 'has-sections': sections }" class="tch-section-nav-wrapper affixed">
            ...
            <div ng-class="{ 'fixed': fixed }" class="tch-section-nav-box dynamic-width">
                <div what="text" class="tch-section-nav-title">
                    ...
                    <!---->
                    <!---->Mofication des offres de prix du cours
                </div>
                <!---->
    ...
    <div class="tch-inline-form">
        ...
        <div ng-class="{ 'slide-hide': !form.isShown, 'slide-show': form.isShown }" class="slide-show" style="" id="abplan-container">
    <!---->
        ...
        <form method="post" action="{{url('pricings', $pricing)}}" class="inline-form-wrapper ng-pristine ng-valid-maxlength ng-invalid ng-invalid-required ng-valid-min ng-valid-max" style="">
            ...
            <div ng-if="planType" class="" style=""><a ng-click="resetPlanType()" href="/schoolAdmin/{{$school->id}}/courses/{{$course->id}}/pricing" class="tch-inline-back fastclickable"><i what="fa-chevron-left" class="fa fa-chevron-left"></i></a>
                ...
                <!----><a what="learn-more-about-payment-plan" ng-href="https://teachable.zendesk.com/hc/en-us/articles/219442088-Overview-of-Course-Pricing-Options" target="_blank" ng-if="planType == 'plan'" class="tch-inline-support-article"
                  href="https://teachable.zendesk.com/hc/en-us/articles/219442088-Overview-of-Course-Pricing-Options"><span>En savoir plus sur les modes de paiement</span></a>
                <!---->
                <div class="inline-form-container col-sm-6 col-sm-offset-3">
                    ...
                    <div ng-if="planType != 'free'" class="col-sm-12">
                        ...
                        <input name="price" id="amount" value="{{$pricing->price}}" type="text" maxlength="15" placeholder="Entrer un prix" convert-currency="currencies[product.currency].ratio"
                              numeric="" required="" autofocus="true" class="form-control ng-pristine ng-empty ng-invalid ng-invalid-required ng-valid-maxlength ng-touched" style="" id="abplan-container">
                    ...
                    <input style="display: none;" type="text" name="type" value="Plan de paiement">
                    ...
                    <div class="col-sm-12 add-top-margin-25"><input type="text" name="name" value="{{$pricing->name}}" maxlength="100" placeholder="Nom de l'offre"
                    ...
                    <div class="col-sm-12" >
                        ...
                        <br>
                        <div>
                                <label for="status"><h4>Statut</h4></label>
                                @if($pricing->status == 0)
                                  <select name="status" id="status" class="select-css">
                    ...
                    <div class="col-sm-12 add-top-margin"><button id="test-id-save-btn" type="submit"  class="tch-btn-header-primary-block">Modifier l'offre</button></div>
                </div>
            </div>
            <!---->
        </form>
