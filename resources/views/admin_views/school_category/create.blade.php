...
@section('title', 'Ajouter une nouvelle catégorie d\'école')
@section('content')
                ...
                <div ng-class="{ 'has-sections': sections }" class="tch-section-nav-wrapper affixed">
                    ...
                    <div ng-class="{ 'fixed': fixed }" class="tch-section-nav-box dynamic-width">
                        <div what="text" class="tch-section-nav-title">
                            ...
                            <!---->
                            <!---->Ajouter une nouvelle catégorie d'école
                        </div>
                        <!---->
                    ...
                    <form enctype="multipart/form-data" method="post" action="{{route('school_category.store',$school->id)}}" class="ng-pristine ng-valid ng-valid-schema-form" id="information-container">
                        ...
                        <bootstrap-decorator form="schemaForm.form[11]">
                            <div class="form-group schema-form-submit ">
                                <!----><input type="submit" class="btn tch-btn-header-primary-block " value="Créez la catégorie">
                                <!---->
                                <!---->
                            </div>
                        </bootstrap-decorator>
