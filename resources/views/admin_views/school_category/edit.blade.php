...
@section('title', 'Modifier la catégorie d\'école')
@section('content')
                ...
                <div class="survey-container col-sm-6 col-sm-offset-3 col-xs-12 m-v-6-m">
                    ...
                    <form enctype="multipart/form-data" method="post" action="{{route('school_category.update',[$school_category->school_id,$school_category->id])}}" class="ng-pristine ng-valid ng-valid-schema-form" id="information-container">
                        ...
                        {{ method_field('patch') }}
                         ...
                         <a href="/schoolAdmin/{{$school->id}}/categorie" class="tch-inline-back fastclickable"><i what="fa-chevron-left" class="fa fa-chevron-left"></i></a>
                        ...
                        <bootstrap-decorator form="schemaForm.form[5]">
                            <div ng-class="{'has-error': form.disableErrorState !== true &amp;&amp; hasError(), 'has-success': form.disableSuccessState !== true &amp;&amp; hasSuccess(), 'has-feedback': form.feedback !== false}"
                              ...
                              <input type="text" name="name" value="{{$school_category->name}}">
                        ...
                        <bootstrap-decorator form="schemaForm.form[6]">
                            ...
                            <input type="hidden" name="school_id" value="{{$school_category->school_id}}">
                            <!---->
                        </bootstrap-decorator>
                        ...
                        <bootstrap-decorator form="schemaForm.form[11]">
                            <div class="form-group schema-form-submit ">
                                <!----><input type="submit" class="btn tch-btn-header-primary-block " value="Modifier la catégorie">
                                <!---->
                                <!---->
                            </div>
                        </bootstrap-decorator>
