...
@section('title', 'Liste des caracteristiques')
@section('page_h2', 'Liste des caracteristiques')
@section('content')
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered first">
                        <thead>
                            ...
                            <tr>
                                <th>Description de la caracteristque</th>
                                <th>Offre Concerné</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @foreach ($characteristic->offers as $offer)
                                        {{$offer->name}},
                                    @endforeach
                                </td>
                                </td>
                                <td>
                                    ...
                                    <a href="{{route('characteristics.edit', $characteristic)}}">Modifier</a>
                                </td>
                            </tr>
                            @endforeach
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"/ajax_characteristic_search_admin",
   method:'GET',
   data:{query:query},
   dataType:'json',
