              ...
              <div class="col-sm-10 col-sm-offset-1">
                ...
                <form method="POST" action="{{ route('register') }}" class="new_teachable_account" id="new_teachable_account" accept-charset="UTF-8">
                  ...
                  <div style="text-align: center;">
                      ...
                      <a href="{{ url('login/facebook') }}" class="btn btn-primary btn-lg btn-block"><i class="fa fa-facebook"></i> {{ __('Inscription avec ') }}<b>Facebook</b></a>
                      <a href="{{ url('login/gmail') }}" class="btn btn-danger-g btn-lg btn-block btn-g"><i class="fa fa-google"></i> {{__('Inscription avec ') }} <b>Google</b></a>
                      <a href="{{ url('login/linkedin') }}" class="btn btn-blue-g btn-lg btn-block btn-g"><i class="fa fa-linkedin"></i> {{__('Inscription avec ') }} <b>Linkedin</b></a>
                      <a href="{{ url('login/github') }}" class="btn btn-black-g btn-lg btn-block btn-g"><i class="fa fa-github"></i> {{__('Inscription avec ') }} <b>Github</b></a>
                  </div>
