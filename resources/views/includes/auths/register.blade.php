...
<html lang="fr" dir="ltr">
  ...
  <body class="">
    <!-- Modal -->
    <div class="modal fade bg-light" id="registerModal" tabindex="-1" aria-labelledby="registerModalLabel" aria-hidden="true" style="z-index:9999;">
        ...
        <div class="modal-content border-0 shadow px-0">
          <div class="position-relative text-center p-3" style="bottom:30px">
            <div class="mx-auto">
              ...
              <div class="">
                <p class="w-75 mx-auto mb-0 text-center h4 pt-3">Bienvenue! Inscrivez-vous</p>
              </div>
          </div>
                    ...
                    <div class="card-body p-0">
                      ...
                      <form method="POST" action="{{ route('register') }}" class="new_teachable_account" id="new_teachable_account" accept-charset="UTF-8">
                        ...
                        <div class="form-group">
                          ...
                          <input required type="email" name="name" class="form-control border-primary form-control-lg border-left-0 border-top-0 border-right-0 bg-light" name="email" id="modal_email_field" aria-describedby="emailHelp">
                        ...
                        <div class="form-group">
                          ...
                          <input type="password" required autocomplete="off" autofocus="autofocus" class="form-control border-primary form-control-lg border-left-0 border-top-0 border-right-0 bg-light" name="password" id="modal_password_field">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputPassword1">Confirmez le mot de passe</label>
                          <input type="password" required autocomplete="off" autofocus="autofocus" class="form-control border-primary form-control-lg border-left-0 border-top-0 border-right-0 bg-light" name="password_confirmation" id="modal_confirm_password_field">
                        </div>
                        <div class="text-center">
                          <button type="submit" class="btn btn-primary btn-lg rounded-pill px-md-4" name="commit" id="signup_final">S'inscrire</button>
                        </div>
                      </form>
                      <br>
                      <div class="container">
                        <p class="font-weight-lighter text-center ">Inscrivez-vous avec <span><i class="fas fa-arrow-down text-dark"></i></span> </p>
                        ...
                        <hr>
                        <p class="text-center">Déjà un compte ?<a href="#" data-dismiss="modal" aria-label="Close" data-toggle="modal" data-target="#loginModal">Connectez-vous</a></p>
                      </div>
                    </div>
                  </div>
                </div>
