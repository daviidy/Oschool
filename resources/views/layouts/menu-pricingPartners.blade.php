...
<body>
  ...
  <!-- End Google Tag Manager (noscript) -->
    ...
    <header class="">
    <!-- Navbar -->
    <div style="background: #000000;" class="navbar navbar-fedora navbar-fixed-top is-at-top bs-docs-nav is-not-signed-in" id="navbar" role="navigation">
        <div class="container">
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-2 first-section">
            ...
            <p>© <span id="year-1">2019</span> OSCHOOL. TOUS DROITS RÉSERVÉS.</p>
        </div>
...
<!--COPYRIGTH SCRIPT-->
    <script type="text/javascript">
        ...
        document.getElementById('year-1').innerHTML = annee;
    </script>
