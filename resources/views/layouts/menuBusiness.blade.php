...
<html lang="fr" dir="ltr">
  ...
  <body>
    <div class="main-content">
      <section class="container-fluid hero-business pb-md-5 pb-3">
        <header>
          <nav class="navbar navbar-expand-sm bg-transparent">
            <ul class="navbar-nav flex-row align-items-center">
              ...
              <li class="nav-item ml-3">
                <img class="logo-short img-fluid" src="/images/schools/logos/logo_oschool_blanc.png" alt="Logo">
                <img class="logo img-fluid" src="/images/schools/logos/logo_oschool_blanc.png" alt="">
              </li>
              <li class="d-none d-md-block nav-item mr-3 ml-3">
                <a href="{{url('schools')}}" class="nav-link text-white">Nos écoles</a>
              </li>
              <li class="d-none d-md-block nav-item mr-3 ml-3">
                <a href="/corporate" class="nav-link text-white">Business</a>
              </li>
