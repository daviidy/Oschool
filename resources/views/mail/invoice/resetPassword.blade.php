        			...
        			<table style="max-width:600px;text-align:center">
        				<tbody>
        					...
        					<tr>
        						...
        						<h2 style="font-size:34px;color:#333;letter-spacing:0.25px;line-height:inherit">Mot de passe oublié</h2>
        						</td>
        					</tr>
        					<tr>
        						<td align="left">
                                <p style="font-size:16px;color:#333;letter-spacing:0.25px;line-height:1.4">
                                    ...
                                    Cliquez sur le lien pour modifier votre mot de passe <br>
