...
<body>
  <table style="width:100%;max-width:960px;position: relative;left:0;right:0;margin: 0 auto;border-collapse: collapse;border-spacing: 0;font-size: 14px;line-height: 24px;color: #333;font-family: Microsoft YaHei;">
    <tr>
      <td style="padding: 20px 7.5% 0;display: block;"><img width="100" src="/images/schools/logos/{{$school->logo}}" /></td>
    </tr>
    <tr>
    ...
    <tr>
      <td style="padding: 20px 7.5% 0;">Vous êtes maintenant administrateur de {{$school->name}}<br>  </td>
    </tr>

    <tr>
      <td style="padding: 20px 7.5% 117px;">Cordialement,<br>l'équipe {{$school->name}}</td>
    </tr>
