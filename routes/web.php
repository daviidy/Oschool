...
//course Session
Route::get('/schoolAdmin/{school}/sessions', 'SessionController@index');
Route::get('/schoolAdmin/{school}/sessions/create', 'SessionController@create');
Route::get('/schoolAdmin/{school}/sessions/{session}', 'SessionController@show');
